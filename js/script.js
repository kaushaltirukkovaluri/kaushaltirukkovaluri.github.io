...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 17.399832, lng: 78.508481, zoom: 16, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 17.399832, lng: 78.508481, title: 'KaushalClicks',
      infoWindow: { content: '<p>Floor 3, Sai Apartments, Street No 10, New Nallakunta Main road, Vidyanagar, Hyderabad</p>' } });
